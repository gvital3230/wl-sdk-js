...
export function Wl_Appointment_Book_Payment_PaymentModel()
{
   ...
   * @property {Wl_Appointment_Book_Payment_PaymentModel_a_purchase_a_tax} a_tax Contains information about taxes in the following format. A list of taxes to apply. The array keys are <tt>k_tax</tt> keys. Each element contains the following fields:
   * <dl>
   *   <dt>
   *     float <tt>m_tax</tt>
   *   </dt>
